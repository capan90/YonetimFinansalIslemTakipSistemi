...
public class GetAuditLogsHandler
{
    ...
    private static string MapAction(AuditAction action) => action switch
    {
        ...
        AuditAction.MailContactCreated      => "Mail Kişisi Oluşturuldu",
        AuditAction.MailContactUpdated      => "Mail Kişisi Güncellendi",
        AuditAction.MailContactDeleted      => "Mail Kişisi Silindi",
