...
public partial class CargoCompanyListScreen : UserControl
{
    ...
    public CargoCompanyListScreen(IServiceProvider services)
    {
        InitializeComponent();
        _services      = services;
    ...
    {
        var form = new CargoCompanyEditWindow(_services) { Owner = HostWindow };
