...
## Gece Bakımı (Nightly Maintenance)

Bu scriptler (HealthCheck, SecurityAudit) gece bakımında merkezi olarak çağrılır.
Bakınız: [`tools/Maintenance/Maintenance.ps1`](../../tools/Maintenance/Maintenance.ps1)
ve [`docs/ScheduledTasks/Maintenance-Framework.md`](../ScheduledTasks/Maintenance-Framework.md).
