...
/// </summary>
public partial class CargoOperationCenterScreen : UserControl, IShellCloseSource
{
    /// <summary>
    ...
    /// <summary>
    /// Sekme başlığı. Ekran bir KAYIT üzerinde çalıştığı için başlık kayda
    /// özgüdür; kabuk bunu <c>ScreenInstance.Title</c> olarak kullanır.
    /// </summary>
    ...
    public CargoOperationCenterScreen(IServiceProvider services, CargoShipmentDto dto)
    {
        ...
        ScreenTitle = $"Operasyon Merkezi — {direction}";
